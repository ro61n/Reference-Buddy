<?php
	session_start();
	header("Location: loggedInHarvardOptionTwo.php");
...
<body style='background-image: url("bg.png"); background-size: 100% 100%; 	background-attachment: fixed;	background-position: center;'>
	...
	<br/>
		...
		<table align="center" height="80px" width='100%'>
				...
				<tr height='50px'>
					<td>
						<a align="left" class="linkbarIndex" href="loggedInHarvardOptionTwo.php" style='padding-left: 30px; padding-right: 30px;'>Harvard: General</a>
				...
				<tr height='50px'>
					<td>
						<br/>
						<a align="left" class="linkbarIndex" href="#" style=' padding-left: 20px; padding-right: 20px;'>Harvard: Australian Style</a>
						<br/>
					</td>
